...
public class DetailsHeaderView extends RelativeLayout {
    ...
    @OnClick(R.id.details_cell_agree_button) void onA() {
        delegate.onAgree();
    }

    @OnClick(R.id.details_cell_disagree_button) void onD() {
        delegate.onDisagree();
    }

    @OnClick(R.id.details_cell_bs_button) void onB() {
        delegate.onBS();
    }

    @OnClick(R.id.details_cell_yes_button) void onY() {
        delegate.onOutcome(true);
    }

    @OnClick(R.id.details_cell_no_button) void onN() {
        delegate.onOutcome(false);
    }

    @OnClick(R.id.details_cell_idk_button) void onI() {
        delegate.onIDK();
    }
